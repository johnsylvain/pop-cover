...
var canvas = document.querySelector('#cover-art');
canvas.width = 1000;
canvas.height = 1000;
...
function () {
  function CoverArt(canvas) {
    ...
    this.gradients = [['#E7DDE0', '#6C84B0'], ['#5878A7', '#7DA2D2'], ['#AED6CD', '#BCE8C8'], ['#DC9655', '#F8B95A']];
  ...
  _createClass(CoverArt, [{
    key: "setArtistName",
    value: function setArtistName(newName) {
      this.artistName = newName === '' ? this.defaultName : newName;
      this.render();
    }
  }, {
    key: "setArtistImage",
    value: function setArtistImage(image) {
      this.artistImage = image;
      this.render();
    }
  }, {
    key: "cycleGradients",
    value: function cycleGradients() {
    ...
    value: function render() {
      ...
      if (this.artistImage) {
        ...
        var ratio = this.canvas.width / this.artistImage.width;
        var height = this.artistImage.height * ratio;
      ...
      var gradient = this.context.createLinearGradient(0, 0, 0, 1000);
...
var coverArt = new CoverArt(canvas);
document.querySelector('#artist-name').addEventListener('input', function (event) {
  var name = event.target.value.trim();
  document.title = "This is".concat(name ? ": ".concat(name) : '');
  coverArt.setArtistName(event.target.value.trim());
});
var imageInput = document.querySelector('#artist-image');
...
document.getElementById('download').addEventListener("click", function () {
  downloadImage(coverArt.export(), "this-is-".concat(coverArt.artistName.toLowerCase().replace(' ', '-'), ".jpeg"));
});
document.getElementById('cycle-colors').addEventListener("click", function () {
  coverArt.cycleGradients();
});

function downloadImage(data) {
  var filename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'untitled.jpeg';
